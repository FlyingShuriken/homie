      ...
      <header className="sticky top-0 z-30 border-b border-stone-200/80 bg-white/80 backdrop-blur">
        <div className="mx-auto flex max-w-full items-center gap-6 px-4 py-4 sm:px-6 lg:px-8">
          <Link href="/" className="flex items-center gap-3">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-stone-950 text-lg font-semibold text-stone-50">
              H
            </div>
            <div>
              ...
              <div className="text-base uppercase tracking-[0.24em] text-stone-500">
                Rental Agent
              </div>
            </div>
          </Link>
          ...
          <nav className="hidden items-center gap-2 md:flex">
            {links.map((link) => (
              <Link
                ...
                href={link.href}
                className={cn(
                  "rounded-full px-5 py-2.5 text-lg transition",
